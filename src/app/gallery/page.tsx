...
export const metadata: Metadata = generatePageMetadata({
  title: 'Gallery — Lagos Event Decoration Portfolio | Decor Adorne',
  description:
    "Browse Decor Adorne's Lagos event decoration portfolio — Engagement, Kamu, Henna Party, Arabian Night, Nikkah, Naming, Picnic, and Rental setups.",
  path: '/gallery',
});
...
const galleryJsonLd = {
  ...
  description: 'Lagos luxury event decoration portfolio — real events styled across Victoria Island, Lekki, Ikoyi, and Mainland Lagos.',
  ...
  return (
    <>
      ...
      <PageHero
        ...
        description="A glimpse into the celebrations we've had the honour of styling across Lagos. Real events, real moments, real beauty."
