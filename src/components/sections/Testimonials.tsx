    ...
    <section className="py-24 sm:py-32 bg-[#FAF7F4]">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        <div className="max-w-xl mb-16">
          ...
          >
            Stories from{' '}
            <em className="italic text-[#C9A96E]">Lagos families.</em>
          </motion.h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((t, i) => (
            <motion.article
              ...
              className="bg-[#F2EDE8] border border-[#E8E0D8] rounded-2xl p-8 flex flex-col gap-6"
        ...
        >
          ...
          <p className="text-sm text-[#1A1410]/60">
            <span className="font-medium text-[#1A1410]">4.9</span> average across 200+ Lagos events
          </p>
        </motion.div>
      </div>
    </section>
